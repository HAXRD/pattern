...
def get_config():
    ...
    parser.add_argument("--use_emulator_pt", action="store_false", default=True,
                        help="by default True, use stored ckpt to as φ_0; else interact with environment (that has no site-specific data) to collect experience and train a baseline env emulator as φ_0") # TODO
