...
def make_square(size=10, filled=True):
    points = []
    points.append(( size/2,  size/2))
    points.append((-size/2,  size/2))
    points.append((-size/2, -size/2))
    points.append(( size/2, -size/2))
    if filled:
...
def make_triangle(size=10, filled=True):
    points = []
    points.append(( size*math.cos(2*math.pi/12), -size*math.sin(2*math.pi/12)))
